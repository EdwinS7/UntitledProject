...
namespace Renderer {
    ...
    void Circle( Vec2<int16_t> position, float radius, float completion, float rotation, int16_t segments, Color color ) {
        gBuffer->Circle( position, radius, completion, rotation, segments, color );
    }

    void FilledCircle( Vec2<int16_t> position, float radius, float completion, float rotation, int16_t segments, Color center_color, Color color ) {
        gBuffer->FilledCircle( position, radius, completion, rotation, segments, center_color, color );
    }
