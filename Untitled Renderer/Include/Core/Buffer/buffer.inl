...
inline void cBuffer::GenerateArcVertices( std::vector<Vertex>* vertices, const Vec2<int16_t>* position, float radius, float completion, float rotation, int16_t segments, Color center_color, Color color, bool filled ) {
