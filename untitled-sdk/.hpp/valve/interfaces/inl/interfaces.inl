...
namespace valve {
	...
	/* temp solution for dbg but prob idc at all @needfix if u need it tho */
	__forceinline void c_cvar::con_print( const bool notify, const std::uint32_t& clr, const char* str ) {
		...
		if ( notify )
			reinterpret_cast< add_notify_t >( g_ctx->addresses( ).m_add_notify )( clr, str );
	...
	__forceinline void c_surface::start_drawing( ) {
		...
		return reinterpret_cast< fn_t >( g_ctx->addresses( ).m_start_drawing )( this );
	}

	__forceinline void c_surface::finish_drawing( ) {
		using fn_t = void( __thiscall* )( decltype( this ) );

		return reinterpret_cast< fn_t >( g_ctx->addresses( ).m_finish_drawing )( this );
	}
	...
	__forceinline void c_surface::add_clred_text(
		...
		return reinterpret_cast< fn_t >( g_ctx->addresses( ).m_add_clred_text )(
	...
	__forceinline void c_font_mgr::calc_text_size( const unsigned long font, const wchar_t* str, int& width, int& height ) {
		...
		return reinterpret_cast< fn_t >( g_ctx->addresses( ).m_calc_text_size )( this, font, str, width, height );
	}
	...
	__forceinline void c_font_mgr::set_font_glyph_set(
		...
		return reinterpret_cast< fn_t >( g_ctx->addresses( ).m_set_font_glyph_set )(
