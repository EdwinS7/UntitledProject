...
namespace valve {
	...
	public:
		__forceinline c_entity* get_entity( );
	};

	class c_renderable {
	public:
		__forceinline c_client_unknown* get_client_unknown( );
	};
	...
	public:
        ...
        __forceinline const vec3_t& get_abs_origin( );
...
#include "../../../.hpp/valve/entities/inl/entities.inl"