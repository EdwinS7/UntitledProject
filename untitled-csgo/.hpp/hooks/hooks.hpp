...
namespace hooks {
	...
	inline decltype( &alloc_key_values_memory ) orig_alloc_key_values_memory{};
	...
	inline decltype( &on_screen_size_change ) orig_on_screen_size_change{};
	...
	float __fastcall get_screen_aspect_ratio( const std::uintptr_t ecx, const std::uintptr_t edx, const int w, const int h );
	inline decltype( &get_screen_aspect_ratio ) orig_get_screen_aspect_ratio{};
